<template>
  ...
  <div>
    <el-input v-if="meta.uitype=='TextBox'" v-model="obj[meta.name]" size="mini" :placeholder="meta.title" maxlength="meta.maxlength">
    </el-input>
    <el-checkbox v-model="obj[meta.name]" v-else-if="meta.uitype=='CheckBox'" :true-label="'1'" :false-label="'0'">
    </el-checkbox>
    <el-switch v-model="obj[meta.name]" v-else-if="meta.uitype=='Switch'" active-value="1" inactive-value="0">
    </el-switch>
   ...
   <el-select v-model="obj[meta.name]" v-else-if="meta.uitype=='DropdownList'" filterable allow-create
    ...
    <el-select v-model="obj[meta.name]" v-else-if="meta.uitype=='List'" filterable multiple allow-create
      default-first-option :placeholder="meta.title" style="width:100%">
      <el-option v-for="sel in meta.items" :key="sel.value" :label="sel.text" :value="sel.value">
      </el-option>
    </el-select>
