...
class AssemblyRef
{
    internal const string Name = "DataGate API服务";
    internal const string Product = "DataGate API服务";
    internal const string Description = @"DataGate API服务,承载DataGate.App的服务宿主";
}