...
namespace DataGate.Com.DB
{
    ...
    /// <returns></returns>
        ...
        /// <summary>
        /// 执行分页查询获取一个DataReader 异步版本
        /// </summary>
        /// <param name="pager">分页对象</param>
        /// <param name="sp">参数列表</param>
        /// <returns>分页的DataReader</returns>
       Task<IDataReader> ExecPageReaderAsync(IPager pager, params IDataParameter[] sp);
        ...
        Task CreateTableAsync(DataTable dt, string tableName);
        /// <summary>
        /// 判断表是否存在
        /// </summary>
