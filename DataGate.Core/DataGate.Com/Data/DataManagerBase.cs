...
namespace DataGate.Com
{
    ...
    /// </summary>
    public class DataManagerBase<T, TId> where T : class, IIdName<TId>
    {
        ...
        public bool Change(T t)
        {
            ...
            {
                throw new Exception(t.Name + " duplicated。");
            }
        ...
        bool CheckValidName(T t)
        {
            ...
            {
                throw new Exception("Duplicate ID:" + exists.Id);
            }
        ...
        public void Add(T t)
        {
            if (!CheckValidName(t))
            {
                throw new Exception(t.Name + "的名称重复。");
            }
